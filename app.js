...
;
    ...
    card1.innerHTML = "MERN + TailwindCSS + shadcn UI authentication, searchjobs, post job, update job, Edit Profile and more... "

    let card2 = document.querySelector(".card-2");

    card2.innerHTML = "MERN, Socket.io, TailwindCSS, JWT Auth, Real-time Messaging, Zustand, Error Handling "
